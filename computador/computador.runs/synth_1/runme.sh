...
HD_PWD='W:/Universidad/Semestre5/Arquitectura/ArquitecturaProyect/computador/computador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testControlU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testControlU.tcl
