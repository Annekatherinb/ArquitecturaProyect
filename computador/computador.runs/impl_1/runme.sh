...
HD_PWD='W:/Universidad/Semestre5/Arquitectura/ArquitecturaProyect/computador/computador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log testControlU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source testControlU.tcl -notrace
